Feature: App statements
  ...
  Scenario: View app statements
    ...
    And there are 20 log statements for "Test App" of "Test Company"
    When I visit the application statements page for "Test App"
    Then I should see the 1 set of 10 log statements for the "Test App" application
    And I follow "Next"
    And I should see the 2 set of 10 log statements for the "Test App" application